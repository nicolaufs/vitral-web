...
$toemails[] = array(
				'email' => 'nicolau.farre@vgmail.es', // Your Email Address
				'name' => 'NFS' // Your Name
			);
...
$fromemail = array(
				'email' => 'no-reply@vitral.es', // Company's Email Address (preferably currently used Domain Name)
				'name' => 'Vitral Grup' // Company Name
			);
...
$recaptcha_secret = '6LfCH9IUAAAAAEAwxaFU_J22CgrMCD0ovIytPsf7'; // Your reCaptcha Secret
...
$mail->SMTPSecure = 'tls';
$mail->SMTPAuth = true;
$mail->Username = "nicolau.farre@gmail.com";
$mail->Password = "b5NbkY4Fyt";
...
$message = array(
	'success'			=> "Correu enviat amb <strong>èxit</strong>. En breus ens posarem en contacte am tu!",
	'error'				=> "<strong>Error</strong> a l'hora d'enviar el correu. Si us plau, torna a intentar-ho més tard o contacta'ns a <strong>vitral@vitral.es</strong>.",
	'error_bot'			=> "Bot Detected! Form could not be processed! Please Try Again!",
	'error_unexpected'	=> "Tenim problemes per rebre el teu correu. Si us plau, torna a intentar-ho més tard o contacta'ns a <strong>vitral@vitral.es</strong>.",
	'recaptcha_invalid'	=> "Captcha incorrecte! Intenta-ho de nou!",
	'recaptcha_error'	=> "Captcha no completat! Si hi ha algun problema, contacta'ns a <strong>vitral@vitral.es</strong>.",
);
